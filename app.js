...
//        var lastPosition = a.getPosition().length() - camera.getPosition().length();
//        var nextPosition = b.getPosition().length() - camera.getPosition().length();
//        return lastPosition < nextPosition ? -1 : 1;
//      });
