function OrbitCamera(input) {
    ...
    this.getViewMatrix = function() {
        ...
        var viewMatrix = this.cameraWorldMatrix.clone().inverse();
        return viewMatrix;
    }
    ...
    this.getPosition = function() {
        ...
        return new Vector3(this.cameraWorldMatrix.elements[12],
                this.cameraWorldMatrix.elements[13],
                this.cameraWorldMatrix.elements[14]);
